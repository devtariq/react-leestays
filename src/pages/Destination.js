          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-12 mb-3">
                <h2 className="section-title">Villas in Lonavala</h2>
                <p>
                  Experience holiday villas in Lonavala by Leestays. We provide
                  exclusive range of top villas on rent in Lonavala. We follow
                  all the SOP’s to provide max safety during pandemic. Escape to
                  the serene landscapes and manmade wonders of Lonavala for an
                  experience that compares to nothing else in this world.{" "}
                </p>
              </div>
            </div>
            <div className="row">
              ...
              <div className="col-lg-12">
                <div className="faq-wrap mt-5">
                  <h2 className="section-title mb-4">
                    What You’ll Find In Lonavala
                  </h2>
                  <p>
                    Lonavala is one of the top tourist destinations and hill
                    stations in India. This place is around 65 km from Pune city
                    and 95 km from Mumbai city. Being close to the most
                    populated metropolitan cities, Lonavala has become a popular
                    weekend getaway. This hill station is connected to nearby
                    cities by railway and national highway. This place also
                    famous for chikki, a traditional Indian sweet (brittle)
                    generally made from nuts and jaggery/sugar.
                  </p>
                  <p>
                    If you want to see a panoramic view of the sahyadri ranges
                    and lush green beauty then you must book a stay in Lonavala.
                    With the peaceful environment of Lonavala’s Villa, you will
                    find a great escape from the hustle and bustle of the city
                    life. You will get to see around 10 big waterfalls around
                    Lonavala. You will find 7 beautiful lakes and many mountains
                    around your bungalow in Lonavala. There are more than 8
                    popular trekking and hiking points in Lonavala.
                  </p>
                  <div className="accordion" id="faq-wrapper">
                    <div className="faq-item">
                      <div className="faq-header" id="headingOne">
                        ...
                        >
                          Is there any extra charge for booking a villa?
                        </h4>
                      </div>
                      <div
                        id="collapseOne"
                        className="collapse faq-content show"
                        aria-labelledby="headingOne"
                        data-parent="#faq-wrapper"
                      >
                        <div className="faq-text">
                          Ans: There are no extra charges for booking villas on
                          Leestays. Prices what you see on the website are final
                          prices.
                        </div>
                      </div>
                    </div>
