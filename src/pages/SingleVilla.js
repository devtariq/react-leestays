                  ...
                  <div className="pckg-head">
                    <div className="pckg-intro">
                      ...
                      <div className="pckg-share">
                        <span>
                          <a href="#">
                            Bookmark <img src="assets/images/bookmarkb.png" alt="" />
                          </a>
                        </span>
                        <span>
                          <a href="#">
                            Share <img src="assets/images/share.png" alt="" />
                          </a>
                        </span>
                      </div>
                    </div>
                    <div className="pckg-img-wrap">
                      <div className="pckg-thubm">
                        <img src="assets/images/pckg1.jpg" alt="" />
                      </div>
                      ...
                      <div className="pckg-txt">
                        <div className="pk-options">
                          <ul>
                            ...
                            <li>
                              <img src="assets/images/matress.png" alt="" />{" "}
                        ...
                        <p>
                          This tropical 3-bedroom luxury villa is found inside
                          Akilea Estate - a holiday estate housing 5 independent
                          private pool luxury villas. The villas can be rented
                          out separately or together, making it perfect for
                          weddings, yoga retreats and events. Villa Kayu Merah
                          is ideal for families, featuring a lovely private
                          garden with a swimming pool, an open-plan living room
                          and 3 bedrooms with ac and open-air en-suite
                          bathrooms. Luxurious, yet affordable - the perfect
                          mix!
                        </p>
                        ...
                        <div className="amenities">
                          ...
                          <ul>
                            ...
                            <li>
                              <img src="assets/images/ac.png" alt="" /> <span>AC</span>
                            </li>
                            <li>
                        ...
                        <div className="villa-video">
                          ...
                          <a
                            className="bridge-video vbox-item"
                            data-vbtype="video"
                            href="https://youtu.be/vsjyFExHz_0"
                          >
                      ...
                      <aside className="sidebar">
                        <div className="widget booking-widget">
                          ...
                          <ul className="booking-options">
                            <li>
                              <strong>11,990</strong> / Sun to Fri
                            </li>
                            <li>
                              <strong>17,990</strong> / Saturday
                            </li>
                          </ul>
                              ...
                              <div className="ac-option">
                                ...
                                >
                                  <div className="ac-option-body">
                                    Non-refundable Cancel before check-in and
                                    get back only the cleaning fee, you’ve paid
                                    one.
                                  </div>
                                </div>
                              </div>
                    ...
                    <div className="col-lg-12">
                      ...
                      <div className="pckg-review">
                        <div className="single-review">
                          ...
                          <p>
                            Great place to stay if you like to visit Anjuna
                            beach more often. Jason (host) and Rama (the
                            caretaker) are very helpful in guiding you what's
                      ...
                      <div className="pckg-location">
                        ...
                        <p>
                          Near Perfect engineering, Gold Valley Sector D, Gold
                          Valley, Lonavla, Maharashtra 410401
                        </p>
                      ...
                      <div className="nearby-place row pt-5 pb-5">
                        ...
                        <div className="col-lg-9 house-rule">
                          ...
                          <ol>
                            <li>
                              Speaker music can only be played till 10 PM in the
                              night.{" "}
                            </li>
                            <li>
                              Swimming pool time is from 2 PM to 9 PM and 6 AM
                              to 9 AM. Swimming in to the pool won’t be allowed
                              in other timeslots.
                            </li>
                            <li>
                              {" "}
                              Remaining booking amount and security deposit
                              needs to be submitted while check-in. Security
                              deposit will be returned while check-out.
                            </li>
                          </ol>
                        </div>
                      </div>
